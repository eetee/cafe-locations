        ...
        return (React.createElement("div", { className: "row", style: blockStyle },
            React.createElement("div", { className: "col-lg-12" },
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-lg-4" }, "Name:"),
                    React.createElement("div", { className: "col-lg-8" }, this.props.store.name)),
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-lg-4" }, "Address:"),
                    React.createElement("div", { className: "col-lg-8" }, this.props.store.address)),
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-lg-4" }, "Co-ordinates:"),
                    React.createElement("div", { className: "col-lg-8" },
                        this.props.store.latitude,
                        ", ",
                        this.props.store.longitude)),
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-lg-4" }, "Distance"),
                    React.createElement("div", { className: "col-lg-8" },
